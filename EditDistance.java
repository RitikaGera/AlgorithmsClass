import java.util.*;
//converting first string to second
...
public class EditDistance{
	...
	public static void main(String[] args){
		...
		System.out.println("The minimum cost is : "+ result[s1.length()][s2.length()]);
	...
	public static void backtrack(int dp[][], String s1, String s2){
			...
			while(true){
				...
				else if(dp[i][j] == dp[i-1][j-1] + REPLACE){
				...
				else if(dp[i][j] == dp[i-1][j] + DELETE){
